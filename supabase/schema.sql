...
CREATE TABLE public.ritase (
    ...
    jenis_pengiriman TEXT NOT NULL CONSTRAINT chk_jenis_pengiriman CHECK (jenis_pengiriman IN ('Pit ke tongkang', 'Pit ke stockfile', 'Quary', 'Stockpile ke tongkang', 'OB')),
    biaya_bbm NUMERIC(15,2) NOT NULL DEFAULT 0 CONSTRAINT chk_biaya_bbm CHECK (biaya_bbm >= 0),
    km_awal NUMERIC(10,2),
    km_akhir NUMERIC(10,2),
...
CREATE TABLE public.invoice (
    ...
    total_ritase INTEGER NOT NULL DEFAULT 0 CONSTRAINT chk_invoice_total_ritase CHECK (total_ritase >= 0),
    potongan NUMERIC(15,2) NOT NULL DEFAULT 0 CONSTRAINT chk_invoice_potongan CHECK (potongan >= 0),
